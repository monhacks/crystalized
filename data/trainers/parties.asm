...
; const BATTLETYPE_SETNOITEMS gonna need this.....a lot

FalknerGroup:
	; FALKNER (1)
	db "FALKNER@", TRAINERTYPE_MOVES
	db 35, SKARMORY,  STEEL_WING, FLY, SPIKES, PROTECT
	db 35, XATU,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db 35, DUGTRIO,  MAGNITUDE, SKY_ATTACK, STOMP, NO_MOVE
	db 35, GOLDUCK,   PSYCHIC_M, SURF, NO_MOVE, NO_MOVE
	db 35, PIDGEOT,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, CLEFAIRY,   DOUBLESLAP, METRONOME, MINIMIZE, ATTRACT
	db 18, SNUBBULL,   TAKE_DOWN, BITE, ATTRACT
...
PryceGroup:
	...
	db 31, PILOSWINE,  ICY_WIND, FURY_ATTACK, BLIZZARD
	db -1 ; end
...
BrockGroup:
	...
	db 44, ONIX,       BIND, ROCK_SLIDE, SANDSTORM
...
ScientistGroup:
	...
	db 60, JYNX, TWISTED_SPOOD, PSYCHIC_M, ICE_BEAM, LOVELY_KISS, ATTRACT
	db 60, 
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, PROTECT, 
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, BLIZZARD
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP,  PROTECT
...
BlaineGroup:
	...
	db 50, MAGMAR,     THUNDERPUNCH, FLAMETHROWER, SUNNY_DAY, CONFUSE_RAY
...
PsychicGroup:
	...
	db 13, ABRA,       TELEPORT, FLASH, NO_MOVE, NO_MOVE
	db 15, KADABRA,    TELEPORT, CONFUSION, NO_MOVE, NO_MOVE
	db -1 ; end
...
SageGroup:
	...
	db 10, ZUBAT,       MEGA_DRAIN, LEECH_LIFE, GUST, NO_MOVE 
	db 10, BEEDRILL,    POISON_STING, TWINEEDLE, HARDEN, NO_MOVE
	db 12, BELLSPROUT,  STUN_SPORE, ACID, MEGA_DRAIN, WRAP
	db -1 ; end

	; SAGE (4)
	db "TROY@", TRAINERTYPE_MOVES
	db  10, PIKACHU,    THUNDERSHOCK, THUNDER_WAVE, QUICK_ATTACK, SEISMIC_TOSS
	db  11, TEDDIURSA,  LICK, TACKLE, GROWL, NO_MOVE
	db  12, BELLSPROUT, ACID, MEGA_DRAIN, WRAP, SLEEP_POWDER
	db -1 ; end
	...
	; SAGE (7)
	db "EDMOND@", TRAINERTYPE_MOVES_ITEM_DVS
	db  14, RATTATA,   TACKLE, FLAME_WHEEL, WATER_GUN, TAIL_WHIP , NO_ITEM, ATKDEFDV_SHINY, SPDSPCDV_SHINY
	db -1 ; end
	...
	db 13, HOOTHOOT,    PECK, MUD_SLAP, TACKLE, REFLECT
	db 13, BELLSPROUT,  GROWTH, ACID, SLEEP_POWDER, MEGA_DRAIN
	db 14, PHANPY,      ICE_SHARD, MUD_SLAP
	db 15, VULPIX,      EMBER, SWIFT, HYPNOSIS,
	db -1 ; end
